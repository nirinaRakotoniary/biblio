...
?>
<h1>Espace admin</h1>
<p>Vous êtes l'admininistrateur de cette plate-forme.</p>
<a href="users.php"><button>Gérer les utilisateurs</button></a>
<a href="books.php"><button>Gérer les livres</button></a>
